...
class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        fun createNotificationChannel(context: Context) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                val rankChannel = NotificationChannel(
                    CHANNEL_RANK_ID, "Rank Achievements",
                    NotificationManager.IMPORTANCE_HIGH
                ).apply {
                    description = "Notifications when you unlock a new rank"
                    enableVibration(true)
        ...
        fun sendRankUnlockNotification(context: Context, rankName: String, quote: String) {
            val nm = context.getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager
            ...
            val pendingIntent = PendingIntent.getActivity(
                context, rankName.hashCode(), launchIntent,
                PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE
            )
            ...
            val notification = NotificationCompat.Builder(context, CHANNEL_RANK_ID)
                ...
                .setContentText("You've reached: $rankName")
                .setStyle(
                    NotificationCompat.BigTextStyle()
                        .bigText("You've reached: $rankName\n\n\"$quote\"")
                )
            ...
            nm.notify(rankName.hashCode(), notification)
        }
    }
